function [lambda, mu, rho, theta1, theta2] = OptimalAlphaBetaTheta(max_matrix_fxy1, ...
    min_matrix_fxy1, max_matrix_fxy2, min_matrix_fxy2, max_matrix_gxy, ...
    min_matrix_gxy, max_matrix_hxy, min_matrix_hxy, m, n, o)
%
% % Inputs
%
% max_fxy1 : (Float)
...
B2 = GetAsVector(max_matrix_gxy);
B2 = B2(1 : nEntries_gxy);

B3 = GetAsVector(max_matrix_fxy2);
B3 = B3(1:nEntries_fxy);

B4 = GetAsVector(max_matrix_hxy);
B4 = B4(1:nEntries_hxy);

B5 = GetAsVector(min_matrix_fxy1);
B5 = B5(1 : nEntries_fxy);

B6 = GetAsVector(min_matrix_gxy);
B6 = B6(1 : nEntries_gxy);

B7 = GetAsVector(min_matrix_fxy2);
B7 = B7(1 : nEntries_fxy);

B8 = GetAsVector(min_matrix_hxy);
B8 = B8(1 : nEntries_hxy);
