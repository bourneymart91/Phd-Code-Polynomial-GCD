function [lambda, mu, alpha, th1, th2] = Preprocess_Both(fxy, gxy, m, n)
    ...
    case true
        ...
        switch optimization_method
            ...
            case 'Together'
                ...
                [alpha, th1,th2] = OptimalAlphaAndTheta_Both(fxy_n, gxy_n, m,n );
        ...
        %str2 = sprintf('Condition S(f(w),alpha*g(w)) : %2.4e', cond(BuildT_Both_Bivariate_2Polys(fww, alpha.*gww, 1, 1)));
