function [C1_xy_matrix] = Implicitize_Integral_Parametric(C1_xt,C1_yt)
% Implicitize the integral parametric curve C1 = (x(t),y(t). Return the
% matrix of coefficients of C1(x,y)
