function [alpha] = GetOptimalAlpha_3Polys(fx,gx,hx)
%
% % Inputs
%
...
Part2 = [ones(n+1,1) zeros(n+1,1)  -1.*ones(n+1,1)];

Part3 = [ones(o+1,1) zeros(o+1,1)  -1.*ones(o+1,1)];

Part4 = [zeros(m+1,1) -1.*ones(m+1,1)  zeros(m+1,1)];

Part5 = [zeros(n+1,1) -1.*ones(n+1,1)  ones(n+1,1)];

Part6 = [zeros(o+1,1) -1.*ones(o+1,1)  ones(o+1,1)];
